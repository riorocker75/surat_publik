...
<div class="ket_surat">
    <b> <p style="text-decoration:underline;"> SURAT KETERANGAN PENAMBAHAN ANGGOTA KARTU KELUARGA </p> </b>
    <span>Nomor : <?php echo $ds->nomor_surat?>/12/UC/SKPnAKK/<?php echo date(Y)?></span>                           
</div>
...
<table class="data_surat">
    ...
    <tbody>
       ...
       <tr>
        ...
        <tr>
            <td>Agama</td>
            <td>:&nbsp;<?php echo ucfirst($dr->agama)?></td>
        </tr>

        <?php if($dr->pendidikan != ""){ ?>
        <tr>
            <td>Pendidikan</td>
            <td>:&nbsp;<?php echo $dr->pendidikan?></td>
        </tr>
        <?php }else{}?>
...
Benar yang tersebut namanya diatas penduduk Gampong Ulee Ceubrek Kecamatan Meurah Mulia Kabupaten Aceh Utara, dan benar ianya ingin melakukan <b>penambahan</b> anggota dari Kartu Keluarga (KK).
</p>
