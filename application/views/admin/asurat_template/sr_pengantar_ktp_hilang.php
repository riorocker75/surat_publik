...
<div class="ket_surat">
    <b> <p style="text-decoration:underline;"> SURAT KETERANGAN KEHILANGAN</p> </b>
    <span>Nomor : <?php echo $ds->nomor_surat?>/12/UC/SKK/<?php echo date(Y)?></span>                           
</div>
...
Benar yang tersebut namanya diatas penduduk Gampong Ulee Ceubrek Kecamatan Meurah Mulia Kabupaten Aceh Utara, dan benar ianya telah <b>kehilangan</b> Kartu Tanda Penduduk (KTP).
</p>
