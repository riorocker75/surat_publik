...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800">Permohonan Surat Keterangan Belum Menikah</h1>
		...
		<div class="row">
            <div class="col-lg-12 mb-4">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <?php show_alert(); ?>
                        <?php echo form_open_multipart('user/act_surat_belum_nikah');?>
                            <div class="row">
                                        ...
                                        <div class="syarat">
                                            <div class="title-syarat">
                                                Persyaratan 
                                                    ...
                                                    <div class="form-group">
                                                        <label style="font-weight:800">Upload Fotocopy KTP (bagi yang sudah meniliki)</label>
