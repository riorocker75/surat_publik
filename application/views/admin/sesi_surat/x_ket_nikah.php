...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800">Permohonan Keterangan Sudah Menikah</h1>
		...
		<div class="row">
            <div class="col-lg-12 mb-4">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <?php show_alert(); ?>
                        <?php echo form_open_multipart('user/act_surat_ket_nikah');?>
                            <div class="row">
                                <div class="col-lg-6 col-md-12 col-12">
                                        ...
                                        <div class="syarat">
                                            <div class="title-syarat">
                                                Data Pasangan Menikah
                                            </div>

                                            <?php foreach($data_diri as $dd ){}?>
                                               
                                            <div class="form-group">
                                            <label style="font-weight:800">Nama / NIK Suami</label>
                                                <select class="selectpicker form-control form-control-user" name="suami" data-live-search="true" required>
                                            ...
                                            <div class="form-group">
                                            <label style="font-weight:800">Nama / NIK Istri</label>
                                                <select class="selectpicker form-control form-control-user" name="istri" data-live-search="true" required>
                                                <!-- <option value="<?php echo $dr->id?>"><?php echo $dr->nik?> | <?php echo $dr->nama?></option> -->
                                                <option value="">Cari Nama/Nik, Pastikan anda sudah terdaftar di sekdes</option>
                                                <?php foreach ($penduduk as $pd){?>
