                                            ...
                                            <div class="title-syarat">
                                                File Persyaratan 
                                                    ...
                                                    <div class="form-group">
                                                        <label style="font-weight:800">Surat Keterangan dari Rumah Sakit bagi yang meninggal di Rumah Sakit</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label style="font-weight:800">Fotocopy KTP (Bagi yang sudah memiliki)</label>
                                        ...
                                        <div class="syarat">
                                            ...
                                            <?php echo form_error('nama_pelapor', '<div class="form-error">', '</div>'); ?>
                                              ...
                                              <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-user"  name="hub_pelapor" placeholder="misal: ibu" required>
                                ...
                                <div class="col-lg-6 col-md-12 col-12">
                                    ...
                                    <div class="title-syarat">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-user"  name="sebab_mati" placeholder="misal: penyakit" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-user"  name="tempat_mati" placeholder="Nama Kota/Kabupaten dimana ia meninggal" required>
