                ...
                <div class="card shadow mb-4">
                 ...
                 <div class="card-body">   
                  ...
                  <div class="tab-content" id="myTabContent">
                      <!-- start diterima -->
                      <div class="tab-pane fade show active" id="diterima" role="tabpanel" aria-labelledby="profile-tab">
                                   ...
                                   <td><?php echo $n++;?></td>
                                    ...
                                    <td>
                                     <?php echo $this->m_dah->jenis_surat_user($sdtl->jenis_surat,$sdtl->surat_mohon_id);?>
                                        ...
                                        &nbsp;&nbsp;
                                        <!-- untuk delete surat -->
                                     <?php echo $this->m_dah->delete_surat_admin_arsip($sdtl->jenis_surat,$sdtl->surat_mohon_id);?>
